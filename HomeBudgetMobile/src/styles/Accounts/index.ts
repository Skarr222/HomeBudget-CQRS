...
export const s = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.primaryDark, margin: 16, borderRadius: 16, padding: 20 },
  heroLabel: { color: "rgba(255,255,255,0.7)", fontSize: 13 },
  heroAmount: { fontSize: 32, fontWeight: "800", marginTop: 4 },
  heroAmountPositive: { color: "#fff" },
  heroAmountNegative: { color: colors.dangerLight },
  ...
  cardLeftBorder: { borderLeftWidth: 4 },
